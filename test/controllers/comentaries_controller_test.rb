...
class ComentariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentary" do
    assert_difference('Comentary.count') do
      post comentaries_url, params: { comentary: { body: @comentary.body, user: @comentary.user } }
    end
  ...
  test "should update comentary" do
    patch comentary_url(@comentary), params: { comentary: { body: @comentary.body, user: @comentary.user } }
